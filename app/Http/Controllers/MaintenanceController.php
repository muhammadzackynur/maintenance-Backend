...
if (file_exists($logoPath)) {
    $section->addImage($logoPath, [
        ...
        // ── FOTO ───────────────────────────────────────────────
        // Lebar konten = A4(21cm) - marginKiri(1.8cm) - marginKanan(1.8cm) = 17.4cm
        // Dalam twips: 17.4cm / 3 kolom = 5.8cm per kolom
        // 1cm = 567 twips => 5.8cm = 3289 twips
        $colWidth  = 2835;
        // Lebar gambar per kolom dalam pixel (1 twip = 0.0176388mm, 1mm ≈ 3.78px)
        // 5.8cm = 58mm = ~219px, kurangi sedikit untuk margin sel
        $imgWidth  = 140;
        $imgHeight = 157;
